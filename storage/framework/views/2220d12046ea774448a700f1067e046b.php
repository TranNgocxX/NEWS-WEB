        ...
        <div class="mb-3">
            ...
            <select class="form-select" id="MaDanhMuc" name="MaDanhMuc" required>
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($category->MaDanhMuc); ?>"><?php echo e($category->TenDanhMuc); ?></option>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/web-news/resources/views/articles/create.blade.php ENDPATH**/ ?>