              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form action="<?php echo e(route('login.action')); ?>" method="POST" class="user">
                    ...
                    <div class="form-group">
                      <input name="MatKhau" type="password" class="form-control form-control-user" id="exampleInputPassword" placeholder="Password">
                    </div>
                    <div class="form-group">
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/web-news/resources/views/auth/login.blade.php ENDPATH**/ ?>